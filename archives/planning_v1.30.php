...
function buildRecapFetes(){
  ...
  // Légende
  html+=`<div style="margin-top:10px;display:flex;gap:16px;flex-wrap:wrap;align-items:center;font-size:.72rem;color:#555">
    <strong>Légende :</strong>
    ${FETES_JOURS.map(j=>`<span style="display:inline-flex;align-items:center;gap:5px">
      <strong style="color:#555;font-size:.72rem">${j}</strong>
      <span style="background:${FETES_COLORS_M[j]};color:#fff;padding:1px 7px;border-radius:3px;font-weight:700;font-size:.68rem">${j} M</span>
      <span style="background:${FETES_COLORS_AM[j]};color:#fff;padding:1px 7px;border-radius:3px;font-weight:700;font-size:.68rem">${j} AM</span>
      <span style="color:#888">${FETES_LABELS[j]}</span>
    </span>`).join('')}
