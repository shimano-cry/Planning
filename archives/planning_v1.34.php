...
function buildTirAnnuel(r){
  ...
  html+=`<tr style="text-align:center;font-weight:800">
    ...
    <th style="padding:5px 8px;background:#c0392b;color:#fff;font-size:14px;font-weight:800;text-align:center" colspan="2" rowspan="2">TOTAL<br><span style="font-size:9px;font-weight:400;color:#ffcccc">& Annulations</span></th>
  </tr>`;
  ...
  Object.entries(sectionsT).forEach(([lbl,agents])=>{
    ...
    agsFilt.forEach((ag,i)=>{
      ...
      html+=`<td colspan="2" style="text-align:center;padding:4px 8px;font-weight:800;font-size:15px;background:#fff0f0;color:${totCol}" title="${tipAnnul}">${tot}${nbAnnul>0?' <span style="font-size:10px;color:#c0392b">❌'+nbAnnul+'</span>':''}</td>`;
      html+='</tr>';
...
function buildRecapFetes(){
  ...
  // Légende
  html+=`<div style="margin-top:10px;display:flex;flex-direction:column;gap:6px;font-size:.72rem;color:#555">
    <strong>Légende :</strong>
    ${FETES_JOURS.map(j=>`<span style="display:inline-flex;align-items:center;gap:6px">
      <strong style="color:#555;min-width:90px">${FETES_LABELS[j]}</strong>
      ...
      <span style="background:${FETES_COLORS_AM[j]};color:#fff;padding:1px 5px;border-radius:3px;font-weight:700;font-size:.68rem;margin-left:4px">AM</span>Après-midi
    </span>`).join('')}
