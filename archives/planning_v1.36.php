...
function buildTirAnnuel(r){
  ...
  Object.entries(sectionsT).forEach(([lbl,agents])=>{
    ...
    agsFilt.forEach((ag,i)=>{
      ...
      html+=`<td colspan="2" style="text-align:center;padding:4px 8px;font-weight:800;font-size:15px;background:#fff0f0;color:${totCol}" title="${tipAnnul}">${tot}${nbAnnul>0?` <span style="font-size:10px;color:#c0392b;vertical-align:middle">❌${nbAnnul}</span>':''}</td>`;
      html+='</tr>';
