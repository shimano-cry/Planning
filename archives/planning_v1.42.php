...
function buildTirAnnuel(r){
  ...
  html+=`<tr style="text-align:center;font-weight:800">
    ...
    <th colspan="2" style="padding:5px 8px;background:#c0392b;color:#fff;font-size:14px;font-weight:800;text-align:center" rowspan="2">TOTAL</th>
  </tr>`;
  ...
  Object.entries(sectionsT).forEach(([lbl,agents])=>{
    ...
    agsFilt.forEach((ag,i)=>{
      ...
      html+=`<td colspan="2" style="text-align:center;padding:4px 8px;font-weight:800;font-size:15px;background:#fff0f0;color:${totCol}" title="${tipAnnul}">${tot}${nbAnnul>0?' ❌'+nbAnnul:''}</td>`;
      html+='</tr>';
