...
runMigrationOnce($mysqli, 'update_couleurs_conges_v3', function(mysqli $db) {
    ...
    // Absences spéciales
    $db->query("UPDATE types_conges SET couleur_bg='#FFFFFF',couleur_txt='#000000' WHERE code='ASA'");
...
$CODES_POLICE_DEFAUT = [
  ...
  'ASA' =>['code'=>'ASA', 'libelle'=>'Autorisation Spéciale d Absence',    'couleur_bg'=>'#FFFFFF','couleur_txt'=>'#000000'],
