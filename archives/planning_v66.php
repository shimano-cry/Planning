  ...
  <div class="login-center-row">
    ...
    <div id="form-login">
      <form method="POST">
        ...
        <input type="text" name="login" autofocus autocomplete="off" required placeholder="Votre identifiant">
    ...
    <div id="form-forgot" style="display:none">
      <form method="POST">
        ...
        <label>Identifiant</label>
        <input type="text" name="login" autocomplete="off" required placeholder="Votre identifiant">
