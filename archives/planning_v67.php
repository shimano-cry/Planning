  ...
  <div class="login-center-row">
    ...
    <div id="form-login">
      <form method="POST">
        ...
        <input type="search" name="login" autofocus autocomplete="off" required placeholder="Votre identifiant" style="appearance:none;-webkit-appearance:none">
    ...
    <div id="form-forgot" style="display:none">
      <form method="POST">
        ...
        <label>Identifiant</label>
        <input type="search" name="login" autocomplete="off" required placeholder="Votre identifiant" style="appearance:none;-webkit-appearance:none">
