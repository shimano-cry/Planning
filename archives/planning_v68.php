...
<div class="login-wrap">
  ...
  <div class="login-center-row">
    ...
    <div id="form-login">
      <?php $fakeId = 'f'.bin2hex(random_bytes(4)); ?>
      <form method="POST" autocomplete="off">
        <input type="hidden" name="action_auth" value="login">
        <!-- Honeypot : trompe l'autocomplete du navigateur -->
        <input type="text" name="<?=$fakeId?>" style="display:none" tabindex="-1" aria-hidden="true">
        <input type="password" name="<?=$fakeId?>_p" style="display:none" tabindex="-1" aria-hidden="true">
        ...
        <input type="password" name="password" autocomplete="off" required placeholder="••••••••" readonly onfocus="this.removeAttribute('readonly')">
