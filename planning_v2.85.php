    ...
    <div class="adm-body">
      ...
      <div class="adm-section active" id="tab-verrous">
        ...
        <div style="display:flex;gap:10px;margin-bottom:14px;flex-wrap:wrap">
          ...
          <?php endif;?>
          <?php if(!$isArchived): ?>
          <button class="btn-action" id="btn-archiver-annee" style="background:#e65100;color:#fff">🗄️ Archiver l'année <?=$annee?></button>
          <?php endif; ?>
        </div>
...
function buildGrid(g){
  ...
  // Couleurs de référence P/R (ADC LAMBERT)
  const PR_COLORS={'P':{bg:'#92d050',txt:'#222'},'R':{bg:'#bfbfbf',txt:'#333'}};
  ...
  if(GROUPES_SPECIAUX.includes(g)){
    if(g==='lcl_parent'){
      ...
      const GIE_COLORS={
        ...
        'J':{bg:'#92d050',txt:'#222'},
        'P':{bg:'#92d050',txt:'#222'},'R':{bg:'#bfbfbf',txt:'#333'}
      };
